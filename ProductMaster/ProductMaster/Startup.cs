...
using ProductMaster.Data.Adapter;
using System;
using System.Diagnostics.CodeAnalysis;
using System.IO;
using System.Reflection;

[assembly: FunctionsStartup(typeof(ProductMaster.Startup))]
namespace ProductMaster
{
    ...
    public class Startup : FunctionsStartup
    {
        ...
        public const string API_NAME = "ProductMaster";
        /// <summary>The version of the API</summary>
        public const string API_VERSION = "v1";
        /// <summary>The description of the API</summary>
        public const string API_DESCRIPTION = "ProductMaster Function";
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            options.ApplicationName = "ProductMaster";
            ...
            builder.Services.AddTransient<IProductTaxonomyAdapter, ProductTaxonomyAdapter>();
            builder.Services.AddTransient<IProductGroupAdapter, ProductGroupAdapter>();
            builder.Services.AddTransient<IDigitalCouponAdapter, DigitalCouponAdapter>();
            builder.Services.AddTransient<IDigitalCouponItemAdapter, DigitalCouponItemAdapter>();
            builder.Services.AddTransient<IDigitalAvailableStoreItemAdapter, DigitalAvailableStoreItemAdapter>();
            builder.Services.AddTransient<IStoreItemAdapter, StoreItemAdapter>();
            builder.Services.AddTransient<IProductPackagingAdapter, ProductPackagingAdapter>();
            builder.Services.AddTransient<IOSAAlertsAdapter, OSAAlertsAdapter>();
